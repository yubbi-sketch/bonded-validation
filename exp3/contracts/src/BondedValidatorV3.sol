...
/// @title BondedValidatorV3 — v0.3 (Exp30): 미개설 주장의 소멸(Optimistic Lapse)
/// @notice BondedValidator(v0.2.1)의 후계. v0.2.1 의 활성(liveness) 공백을 닫는다:
...
///         스크래치 원본: scratchpad/exp30-openlens/src/BondedValidatorV3.sol 에서
///         openerRefund·deadPool·OpenerRefunded 제거, disengage·생성자 범위검사·ClaimLapsed 추가.
contract BondedValidatorV3 {
